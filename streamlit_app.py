                ...
                if st.button("🚀 Calculate Net Returns", type="primary"):
                    ...
                    if result_df.empty:
                        ...
                        display_cols = [
                            ...
                            'Mgmt_Fee', 'Mgmt_Charged', 'After_Mgmt', 'Hurdle_Met',
                            'Perf_Fee_Paid', 'Net_Value','Period_Return_%', 'HWM'
                        ]
                        # display_cols = [
                        #     'Month_Display', 'Input_Return', 'Gross_Value', 
                        ...
                        display_df.columns = ['Month', 'Input', 'Gross', 
                                            'Mgmt Fee', 'Mgmt Charged?', 'After Mgmt', 'Hurdle Met',
                                            'Perf Paid', 'Net Value','Return %', 'HWM']
